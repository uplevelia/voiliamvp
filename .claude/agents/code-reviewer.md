---
name: code-reviewer
description: Review code quality, check complexity, identify code smells, and suggest refactoring. Expert in maintainability, design patterns, and best practices.
