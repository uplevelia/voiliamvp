---
name: log-analyzer
description: Parse logs, detect error patterns, analyze failure rates, and identify root causes. Expert in Docker logs, application logs, and incident analysis.
