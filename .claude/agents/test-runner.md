---
name: test-runner
description: Execute tests, analyze coverage, debug test failures, and provide testing best practices. Expert in pytest, fixtures, mocking, and CI/CD integration.
